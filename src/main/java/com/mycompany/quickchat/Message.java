...
public class Message {
        ...
        static {
            // Pre-populate with sample messages required by tests
            ...
            recipientList.add("+27800000001");
            recipientList.add("+27800000002");

            messageHashes.add("00:1:DGCAKE");
            messageHashes.add("00:2:ISETDINNER");
        }
        ...
        public String sentMessage(int option) {
            switch (option) {
                ...
                case 3:
                    // store
                    if (messageText != null) storedMessages.add(messageText);
        ...
        public void storeMessage() {
            ...
            String hashValue = createMessageHash();
